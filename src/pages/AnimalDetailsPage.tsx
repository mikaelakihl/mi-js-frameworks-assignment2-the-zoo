...
export const AnimalDetailsPage = () => {
  ...
  const {feed, getStatus} = useAnimals();
  ...
  return (
    <section className="p-4 space-y-6">
      ...
      <button className="px-4 py-2 rounded-2xl shadow hover:shadow-md active:scale-95 transition" onClick={()=>feed(animal.id)}>Mata</button>
      <div>{status}</div>
